...
function showMoreText(card) {
    ...
    const productText = "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean";
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${productText}</div>`);
